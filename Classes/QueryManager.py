class QueryManager:
    ...
    def __init__(self, db_manager, utility):
        self.db_manager = db_manager
        self.utility = utility
        self.airports_in_city = self.utility.to_csv_decorator(self.airports_in_city)
        self.boeing_planes = self.utility.to_csv_decorator(self.boeing_planes)
        self.cities_with_boeing_in_dates = self.utility.to_csv_decorator(self.cities_with_boeing_in_dates)
        self.create_indexes()
        self.create_views()
